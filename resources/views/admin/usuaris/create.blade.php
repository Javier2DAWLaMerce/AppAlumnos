...
<section class="px-6 py-8">
    <main class="max-w-lg mx-auto mt-10">
        <div class="border border-gray-200 p-6 rounded-xl">
            <h1 class="text-center font-bold text-xl">Nou usuari</h1>
            ...
            <form method="POST" action="/registre" class="mt-10">
                ...
                <div class="mt-6">
                    ...
                    <input class="border border-gray-200 p-2 w-full rounded" type="text" name="name" id="name"  value="{{old('name')}}">
                    @error('name')<!-- De esta manera podemos recuperar si hubiese un error a la hora de registrarse, -->
                ...
                <div class="mt-6">
                    ...
                    <input class="border border-gray-200 p-2 w-full rounded" type="text" name="username" id="username" value="{{old('username')}}">
                    @error('username')<!-- De esta manera podemos recuperar si hubiese un error a la hora de registrarse, -->
                    <p class= "text-red-500 text-xs mt-2">{{$message}}</p>
                    @enderror
                </div>
                <div class="mt-6">
