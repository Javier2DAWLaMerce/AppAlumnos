...
@section('content')
    ...
    @if (session()->has('registroRealizado'))
        <!--Este if recoge del controlador el metodo flash y si se ha realizado session correctamente entra en el primer if -->
